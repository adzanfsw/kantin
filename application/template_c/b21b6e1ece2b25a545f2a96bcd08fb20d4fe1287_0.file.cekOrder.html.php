<?php
/* Smarty version 4.3.1, created on 2024-04-07 20:16:26
  from 'C:\xampp\htdocs\kantin\application\views\admin\order\cekOrder.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66129caa5bf7a2_58090314',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b21b6e1ece2b25a545f2a96bcd08fb20d4fe1287' => 
    array (
      0 => 'C:\\xampp\\htdocs\\kantin\\application\\views\\admin\\order\\cekOrder.html',
      1 => 1712495485,
      2 => 'file',
    ),
  ),
...
function content_66129caa5bf7a2_58090314 (Smarty_Internal_Template $_smarty_tpl) {
						...
						<tr style="border-top: 2px dotted #d8d8d8; background-color: #FAFDFF;">
							...
							<td colspan="2" class="text-center">
								<div class="form-group row mb-4" style="margin-top: 25px;">
									...
									<div class="col-sm-12 col-md-7">
										<?php if ($_smarty_tpl->tpl_vars['order']->value['status'] == 'Order Selesai') {?>
											<button class="btn btn-md btn-outline-primary" disabled><i class="far fa-check"></i> Order Selesai</button>
										<?php } else { ?>
											<button class="btn btn-md btn-outline-danger" disabled><i class="far fa-check"></i> Order Dibatalkan</button>
										<?php }?>
									</div>
								</div>
							</td>
